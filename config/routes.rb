...
Rails.application.routes.draw do
  ...
  resource :user, only: %i(edit), shallow: true do
  ...
  delete "/users" => "users_payment#destroy", :as => "user"

  controller :users_payment do
    get "donate"                   => :donate_settings,        :as => :donate_settings
    put "donate"                   => :update_donate_settings, :as => :update_donate_settings
  end
  ...
  devise_scope :user do
    ...
    post "/users"        => "registrations_payment#create", :as => :user_registration
  end
